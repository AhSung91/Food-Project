...
<article>
	<div class="container" role="main">
		...
		<div class="table-response">
			<form action="../BoardWriteCon4.do" method="post" role="form" name="form" id="form">
			...
			<div align="center">
				...
				<button type="button" class="btn btn-md btn-info" id="list" onclick="location.href='../BoardListCon4.do'">목록으로</button>
			</div>
			<p>&nbsp;</p>
		</form>
		</div>
