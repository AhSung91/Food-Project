                        ...
                        <li class="item">
                            ...
                            <ul>
                                <span>
                                    ...
                                    <li><a href="random.jsp">오늘점심뭐먹지?</a></li>
...
function makeOutListener(infowindow) {
    return function() {
        infowindow.close();
            ...
            onclick="javascript:window.location='index2.jsp'">   
        ...
        <div id="footer" class="up-on-scroll">
            <div class="footer">
                <ul>
                    ...
                    <li><a href="#">Contact to 박용만</a></li>
                    <li><a href="#">Contact to 김아성</a></li>
                    <li><a href="#">Contact to 이다운</a></li>
                    <li><a href="#">Contact to 김민주</a></li><br>
